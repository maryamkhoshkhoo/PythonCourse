    ...
    def __init__(self):
        ...
        for i in range(len(line)):
            ...
            if info[0] == 'film':
                ...
                self.movie.append(Clip(info[0],info[1],info[2],info[3],info[4],info[5],info[6],info[7],info[8])) 

            elif info[0] == 'documentary':
                self.movie.append(Documentary(info[0],info[1],info[2],info[3],info[4],info[5],info[6],info[7]))
